...
![ERC-8183 작업 상태 기계: Open, Funded, Submitted, Completed, Rejected, Expired 여섯 상태와 여덟 개 전환을 보여주는 다이어그램. Completed는 provider 지급으로, Rejected·Expired는 client 환불로 이어진다.](/images/posts/ai-agent-commerce-coordination-erc-8183-8226-8001/erc8183-job-lifecycle.svg "ERC-8183 작업 수명주기 상태 기계")

*위 다이어그램은 [ERC-8183 공식 스펙](https://eips.ethereum.org/EIPS/eip-8183)에 정의된 Draft 수명주기를 도식화한 것이다. 표에 있는 여덟 전환을 그대로 옮겼을 뿐, 스펙이 아직 Draft인 만큼 최종 확정 인터페이스는 아니다.*
