...
![ERC-8004 신원·평판·검증 레지스트리에서 ERC-8126 위험 점수를 거쳐 ERC-8196 정책 검사로 이어지는 AI 에이전트 지갑 신뢰 스택 다이어그램](/images/posts/ai-agent-wallet-trust-stack-erc-8004-8126-8196/trust-stack-layers.svg)
