...
[ERC-8196](https://eips.ethereum.org/EIPS/eip-8196)은 Last Call 단계로 올라갔고 마감일은 2026-07-14다. Last Call도 여전히 동료 검토 절차이지 Final이 아니어서, 마감일 전이나 이슈가 발견되면 interface와 보안 모델이 바뀔 수 있다. 저자는 Leigh Cronian(@cybercentry), Chris Johnson이다.
...
- ERC-8196은 Last Call 단계다. 마감일(2026-07-14) 전이나 이슈가 발견되면 interface와 보안 모델이 여전히 바뀔 수 있다
...
- [ERC-8196: AI Agent Authenticated Wallet](https://eips.ethereum.org/EIPS/eip-8196) — ethereum.org, Last Call (마감 2026-07-14), 조회일 2026-07-04
