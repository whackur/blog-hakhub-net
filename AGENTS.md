...
- **Finance** — 퀀트 금융 오픈소스, 금융 인프라·핀테크 기술 (연구·교육 관점, 투자 조언 아님)

카테고리(`categories`)는 **AI / Blockchain / Security / Finance** 4개로 운영한다. 세부 주제(local-llm, physical-ai, quant-finance 등)는 `tags`로.
